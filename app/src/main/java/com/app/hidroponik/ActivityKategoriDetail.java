...
import com.app.hidroponik.adapter.AdapterProduct;
...
public class ActivityKategoriDetail extends AppCompatActivity {
    private static final String EXTRA_OBJECT = "key.EXTRA_OBJECT";

    // activity transition
    public static void navigate(Activity activity, Category obj) {
        Intent i = new Intent(activity, ActivityKategoriDetail.class);
    ...
    private void initComponent() {
        ...
        mAdapter.setOnItemClickListener(new AdapterProduct.OnItemClickListener() {
            ...
            public void onItemClick(View v, Product obj, int position) {
                ActivityDetailProduk.navigate(ActivityKategoriDetail.this, obj.id, false);
            }
        });
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(item_id == android.R.id.home){
            ...
            ActivitySearch.navigate(ActivityKategoriDetail.this, category);
