...
import com.app.hidroponik.adapter.AdapterOrderHistory;
import com.app.hidroponik.adapter.AdapterShoppingCart;
...
import com.app.hidroponik.model.Order;
import com.app.hidroponik.utils.Tools;

import java.util.List;

public class ActivityCatatanPesan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_catatan_pesan);
    ...
    private void dialogOrderHistoryDetails(final Order order) {
        final Dialog dialog = new Dialog(ActivityCatatanPesan.this);
        dialog.requestWindowFeature(Window.FEATURE_NO_TITLE); // before
        dialog.setContentView(R.layout.dialog_pesan_history_detail);
