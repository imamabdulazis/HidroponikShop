...
import com.app.hidroponik.ActivityArtikelDetail;
import com.app.hidroponik.ActivityMain;
import com.app.hidroponik.R;
import com.app.hidroponik.adapter.AdapterFeaturedNews;
    ...
    private void displayResultData(List<NewsInfo> items) {
        ...
        adapter.setOnItemClickListener(new AdapterFeaturedNews.OnItemClickListener() {
            ...
            public void onItemClick(View view, NewsInfo obj) {
                ...
                ActivityArtikelDetail.navigate(getActivity(), obj.id, false);
            }
        });
