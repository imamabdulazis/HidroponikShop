...
import com.app.hidroponik.adapter.AdapterFullScreenImage;
import com.app.hidroponik.utils.Tools;

import java.util.ArrayList;

public class ActivityFullGambar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new AdapterFullScreenImage(ActivityFullGambar.this, items);
