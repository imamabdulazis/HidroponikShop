...
import com.app.hidroponik.model.Notification;
import com.app.hidroponik.utils.Tools;

public class ActivityDialogNotifikasi extends AppCompatActivity {
    ...
    public static Intent navigateBase(Context context, Notification obj, Boolean from_notif) {
        Intent i = new Intent(context, ActivityDialogNotifikasi.class);
    ...
    private void initComponent() {
        ...
        if (notification.type.equals("PRODUCT")) {
            intent = ActivityDetailProduk.navigateBase(this, notification.obj_id, from_notif);
        } else if (notification.type.equals("NEWS_INFO")) {
            intent = ActivityArtikelDetail.navigateBase(this, notification.obj_id, from_notif);
        } else {
        ...
        ((Button) findViewById(R.id.bt_delete)).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!from_notif && position != -1) {
                    ...
                    ActivityNotifikasi.getInstance().adapter.removeItem(position);
                    Snackbar.make(ActivityNotifikasi.getInstance().parent_view, "Hapus Berhasil", Snackbar.LENGTH_SHORT).show();
                }
            }
        });
    }
