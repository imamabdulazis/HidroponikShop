...
public class ActivityTasBelanja extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tas_belanja);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item_id == android.R.id.home) {
            ...
            if (adapter.getItemCount() > 0) {
                Intent intent = new Intent(ActivityTasBelanja.this, ActivityCheckout.class);
    ...
    private void dialogCartAction(final Cart model) {
        ...
        final Dialog dialog = new Dialog(ActivityTasBelanja.this);
