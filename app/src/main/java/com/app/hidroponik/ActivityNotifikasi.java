...
import com.app.hidroponik.adapter.AdapterNotification;
...
public class ActivityNotifikasi extends AppCompatActivity {
    ...
    static ActivityNotifikasi activityNotifikasi;

    public static ActivityNotifikasi getInstance() {
        return activityNotifikasi;
    }
    ...
    private void iniComponent() {
        ...
        adapter.setOnItemClickListener(new AdapterNotification.OnItemClickListener() {
            ...
            public void onItemClick(View view, Notification obj, int pos) {
                obj.read = true;
                ActivityDialogNotifikasi.navigate(ActivityNotifikasi.this, obj, false, pos);
            }
        });
